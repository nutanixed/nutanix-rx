#!/bin/bash
# startup_ndk_webhook.sh - Restore NDK webhook failure policies to Fail (production mode)
...
# Set policy to Fail for startup
POLICY="Fail"

echo "--- Setting NDK Webhooks to $POLICY mode (Startup Restore) ---"
